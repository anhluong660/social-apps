...
public class UserManagerController {
    ...
    public GeneralResponse<String> addFriend(@RequestHeader("userId") Long userId,
    ...
    public GeneralResponse<String> removeFriend(@RequestHeader("userId") Long userId,
                                                @PathVariable Long friendId) {
        if (Objects.equals(friendId, userId)) {
            return GeneralResponse.fail();
        }
    ...
    @GetMapping("/friends")
    public GeneralResponse<List<ResFriendInfo>> getAllFriend(@RequestHeader("userId") Long userId) {
        List<ResFriendInfo> listRes = userManagerService.getAllFriend(userId);
        return GeneralResponse.success(listRes);
    }

    @GetMapping("/inviters")
    public GeneralResponse<List<ResFriendInfo>> getAllInviter(@RequestHeader("userId") Long userId) {
